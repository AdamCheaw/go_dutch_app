      ...
      <v-tabs-slider color="primary"></v-tabs-slider>
        ...
        <v-tab href="#tab-2">
          ...
          <v-badge color="red" overlap v-model="showBadge">
            <span slot="badge" class="text-xs-center">{{howManyRecords}}</span>
          ...
          <v-card flat>
            <v-card-text class="ma-sm-0 pa-sm-0">
              ...
              <v-list two-line subheader>
                <div v-for="(doc,index) in currentBills"
                  :key="index"
                >
                  ...
                  >
                    ...
                    <div class="Total" style="" >
                      ...
                      <h3 v-if="isMe(doc.payer)" class="info--text">
                        +NT {{calBill(record.total,record.divide,record.debtorDivide)}}
                      </h3>
